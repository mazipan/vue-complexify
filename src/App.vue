<template>
  <div id="app" class="VueComplexify">
...
.input{
  ...
  &--error{
    border-color: #F8011E !important;
    outline: none;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(248, 1, 30, 0.5) !important;
  }
}
